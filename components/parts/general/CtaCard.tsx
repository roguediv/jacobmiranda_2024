          ...
          <div className="sct-content">
            <div className="card">
              ...
              <div className="content">
                ...
                <p>If you like what you've seen and believe I can add value to your development, let's connect! I'm passionate about creating innovative solutions and am eager to contribute to your company's success. </p>
