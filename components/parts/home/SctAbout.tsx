      ...
      <div className={'about'}>
        ...
        <div className="left">
          ...
          <div className="profile">
            <svg preserveAspectRatio="none" width="310" height="81" viewBox="0 0 310 81" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0_0_1" style={{'maskType':'alpha'}} maskUnits="userSpaceOnUse" x="0" y="0" width="310" height="81"><path d="M308.972 1H1V80.2905H271.5L308.972 1Z" fill="#D9D9D9" stroke="#83AB95" stroke-width="0.821663"/></mask><g mask="url(#mask0_0_1)"><path d="M308.972 1H1V80.2905H271.5L308.972 1Z" fill="#0A4350" fill-opacity="0.85" stroke="#83AB95" stroke-width="0.821663"/><path fill-rule="evenodd" clip-rule="evenodd" d="M258.145 83.2904H1.25H-1.75V80.2904V0.999979V-2.00002H1.25H293.875L295.641 -5.69128L303.354 -2.00002H309.154H314.062L311.953 2.11559L323.604 7.69124L281.967 94.6912L258.145 83.2904ZM291.003 3.99998H4.25V77.2904H255.927L291.003 3.99998Z" fill="#60F49C"/></g></svg>
            <div className="inner">
        ...
        <div className="col-2">
          <div className="grid r1">
            ...
            <div className="col-2">
              ...
              <Link href="https://whimsydecorstl.com/media/resume.pdf" className="ignore button" target="_blank"><button>Resume</button></Link>
            </div>
          </div>
