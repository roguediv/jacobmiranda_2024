    ...
    <section id="home-sct-1" className={`SctHire theme-light ${className}`}>
      <div className="sct-content">
        <div className="r1">
          ...
          <div className="p2">
            <p>With over 5 years of development experience, I offer a competitive mindset. I dedicate substantial time to researching the latest trends, constantly enhancing my skills. My devotion for development goes beyond work, it’s a source of joy. This enthusiasm fuels projects in my free time, and I am eager to apply this passion on new ventures.</p>
            <SvgGreenBarsBorder />
